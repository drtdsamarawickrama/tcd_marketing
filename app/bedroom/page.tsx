  ...
  return (
    <div className="flex flex-col min-h-screen bg-zinc-50 font-sans">
      ...
      <main className="flex-grow">
        ...
        {/* Banner Section */}
        <section className="bg-gradient-to-r from-amber-800 to-amber-950 text-white py-16 px-6 shadow-inner">
          <div className="max-w-7xl mx-auto space-y-3">
            <span className="text-xs uppercase font-extrabold tracking-widest text-amber-200 bg-amber-900/30 px-3 py-1 rounded-full">
            ...
            <p className="max-w-xl text-sm md:text-base text-zinc-100">
              Create your perfect sleeping space with solid wood bed frames, spacious closets, elegant dressing tables, and orthopedic spring mattresses.
            </p>
          </div>
        </section>
